...
const Login = () => {
  const [searchParams] = useSearchParams();
  const defaultTab =
    searchParams.get("tab") === "account" ? "account" : "password";
  ...
  const [
    registerUser,
    { isLoading: registerLoading, isSuccess: registerSuccess, error: registerError },
  ] = useRegisterUserMutation();

  const [
    loginUser,
    { isLoading: loginLoading, isSuccess: loginSuccess, data: loginData, error: loginError },
  ] = useLoginUserMutation();
  ...
  useEffect(() => {
    if (registerError) {
      toast.error(registerError?.data?.message || "Signup error");
    }
    if (loginError) {
          ...
          <Card>
            ...
            <form onSubmit={handleSignup}>
              <CardContent className="space-y-4">
                ...
                <Input name="name" placeholder="Name" onChange={(e) => changeHandler(e, "signup")} />
                <Input name="email" placeholder="Email" onChange={(e) => changeHandler(e, "signup")} />
                <Input name="password" type="password" placeholder="Password" onChange={(e) => changeHandler(e, "signup")} />
        ...
        <TabsContent value="password">
          <Card>
            ...
            <form onSubmit={handleLogin}>
              <CardContent className="space-y-4">
                <Input name="email" placeholder="Email" onChange={(e) => changeHandler(e, "login")} />
                <Input name="password" type="password" placeholder="Password" onChange={(e) => changeHandler(e, "login")} />
              </CardContent>
